...
myx = [[a1, b1] for a1, b1 in zip(a,b)]
print myx
myy = [1464,1394,1357,1293,1256,1254,1234,1195,1159,1167,1130,1075,1047,965,943,958,971,949,884,866,876,822,704,719]
hof = linear_model.LinearRegression()
hof.fit(myx, myy)
print 'Intercept: \n', hof.intercept_
print 'Coefficients: \n', hof.coef_
